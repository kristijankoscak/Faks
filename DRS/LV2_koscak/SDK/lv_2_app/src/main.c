...
//u32 RESET_VALUE =  (XPAR_DELAY_BASEADDR + 2)*XPAR_DELAY_CLOCK_FREQ_HZ;
int RESET_VALUE = 49999999;
//******************************************************************************************************//
 ...
 u8 TmrCtrNumber)
{
    ...
    XTmrCtr_SetOptions(TmrCtrInstancePtr,TmrCtrNumber,XTC_DOWN_COUNT_OPTION|XTC_INT_MODE_OPTION|XTC_AUTO_RELOAD_OPTION);
...
void TimerCounterHandler(void *CallBackRef, u8 TmrCtrNumber)
{
	...
	TimeExpired ++;
	XGpio_DiscreteWrite(&leds,1,TimeExpired);
